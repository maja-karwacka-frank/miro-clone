...
export const SelectionBox = memo(
	({ onResizeHandlePointerDown }: SelectionBoxProps) => {
		...
		return (
			<>
				<rect
					className='fill-transparent stroke-pink-500 stroke-2 pointer-events-none'
					style={{
				...
				{isShowingHandles && (
					<>
						<rect
							className='fill-white stroke-pink-500 stroke-1'
							x={0}
							y={0}
							style={{
								cursor: 'nwse-resize',
						...
						/>
						<rect
							className='fill-white stroke-1 stroke-pink-500'
							x={0}
							y={0}
							style={{
								cursor: 'ns-resize',
